...
# * Output save path
runs_folder_path = 'C:/Users/alexc/Documents/Capstone/yolov5/runs/detect'
output_folder_path = 'C:/Users/alexc/Documents/Capstone/yolov5/output'
...
def get_video_for_processing(video_link=''):
    try:
        ...
        folder_util.checkIfFolderExistsAndCreateIfNot(data_folder_path)
        # * Download the file and load the raw data
        downloadVideoGivenURLAndSaveToPath(video_link, video_save_path)

        print('Downloaded video')

        # * Create the subprocess
        stride = 1
        detect_python_path = 'C:/Users/alexc/Documents/Capstone/yolov5/detect.py'
        process = f'python {detect_python_path} --source {video_save_path} --vid-stride {stride} --conf-thres {0.4}'
        callSubProcess(process)
